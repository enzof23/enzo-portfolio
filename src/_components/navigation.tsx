...
export function MobileNav() {
  return <div className="flex sm:hidden">mobile</div>;
}
export function DesktopNav() {
  const { pathname } = useLocation();

  return (
    <div className="fixed h-screen left-5 top-0 hidden sm:flex sm:items-center lg:left-10">
      <div className="flex flex-col gap-3">
          ...
          return (
            ...
            >
              ...
              >
                ...
                />
                <p
                  className={`hidden px-1 text-lg font-inter font-bold capitalize bg-gradient-to-b from-neutral-50 to-neutral-50/30 bg-clip-text text-transparent overflow-hidden whitespace-nowrap ${
        ...
        <div className="group border rounded-full border-white/10 bg-neutral-900 w-fit p-2">
          <div className="flex gap-2 items-center group-hover:animate-widthGrow">
            ...
            <p className="hidden px-1 text-lg font-inter font-bold capitalize bg-gradient-to-b from-neutral-50 to-neutral-50/30 bg-clip-text text-transparent group-hover:flex overflow-hidden whitespace-nowrap">
              my resume
            </p>
          </div>
        </div>
